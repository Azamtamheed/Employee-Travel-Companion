...
cout<<"\t\t\t\t\t\tWELCOME\n........................................................................................................................"<<endl;
    ...
    int numDays;
    double airfareExpenses=0,rentalCarExpenses=0,privateCarExpenses=0,taxiExpenses=0,parkingExpenses=0,breakfastExpenses=0,LunchExpenses=0,dinnerExpenses=0,
...
void getTime(double &depart, double &arrival)
{
    ...
    cin>>depart;
while (depart < 00.00 || depart > 23.59)//input validation
{
...
cin>> arrival;
while (arrival < 00.00 || arrival > 23.59)//input validation
{
    cout << "Invalid input, Please enter a valid time in military format (HH.MM):";
    cin >> arrival;
}
...
{
    int breakfastdays;
    //TO check if lunch, breakfast or dinner will be provided by the company
    if(departure<7.00)
    ...
    double breakfastExpensesArray[breakfastdays]; // Array to store breakfast expenses
    ...
    for (int count = 0; count < breakfastdays; count++) {
     ...
     allowedBreakfast=15*breakfastdays;//total allowed on breakfast
     
    return totalBreakfast;//total exp on breakfast
}
...
double Lunch(double LunchExpenses, double &departure, double &arrival,int tripDays,double &allowedLunch){
    ...
    double lunchExpensesArray[lunchdays]; // Array to store lunch expenses
    ...
    allowedLunch=25*lunchdays;//total allowed on lunch
    
    return totalLunch;//total exp on lunch
}
...
double Dinner(double DinnerExpenses, double &departure, double &arrival,int tripDays,double &allowedDinner)
{
    ...
    cout<<dinnerdays<<endl;
     ...
     double dinnerExpensesArray[dinnerdays]; // Array to store dinner expenses
    ...
    allowedDinner=20*dinnerdays;//total allowed on dinner

    return  totalDinner;//total exp on dinner
}
